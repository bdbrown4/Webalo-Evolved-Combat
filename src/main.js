...
const menus = new Menus(root, settings, input, audio, {
  ...
  onDailySurvival: (ch) => { menus.hide(); game.startDailySurvival(ch); },
  onDailyMission: (ch) => { menus.hide(); game.startDailyMission(ch); },
  onPvpHost: (opts) => { menus.hide(); game.pvpHost(opts); },
  onPvpJoin: (code) => { menus.hide(); game.pvpJoin(code); },
  onCoopHost: (mode) => { menus.hide(); game.coopHost(mode); },
  onCoopJoin: (code, mode) => { menus.hide(); game.coopJoin(code, mode); },
  onCoopHostManual: (mode) => { menus.hide(); game.coopHostManual(mode); },
  onCoopJoinManual: (mode) => { menus.hide(); game.coopJoinManual(mode); },

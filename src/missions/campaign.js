...
const RAW_CAMPAIGN = [
  ...
  },
  {
    ...
    segments: [
      ...
      { kind: 'outdoor', size: 'l', objectiveText: 'Reach the lost Vanguard — drive into the hangar. Mind the edges.',
        enemies: [{ type: 'floater', count: 6 }, { type: 'wobbler', count: 3 }], pickups: [], cover: 0, event: 'vehicle-escape',
        dialogue: [

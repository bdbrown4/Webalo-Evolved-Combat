...
const RAW_CAMPAIGN = [
  ...
  },
  {
    ...
    segments: [
      ...
      { kind: 'bridge', size: 'l', objectiveText: 'Cross the collapsing span and reroute the core controls',
        enemies: [{ type: 'floater', count: 4 }, { type: 'wobbler', count: 2 }, { type: 'gurg', count: 2 }], pickups: [{ type: 'weapon', weapon: 'stinger' }, { type: 'health' }], cover: 0.25, event: 'reactor',
        dialogue: [
          { speaker: 'IRIS', line: "Console's ahead. Slot the override and the core stops pretending it's fine." },
          { speaker: 'Vanguard', line: 'Whole bridge is buckling under me, IRIS.' },
        ] },
      ...
      { kind: 'outdoor', size: 'l', objectiveText: 'Floor it through the tear before the halo fires',
        enemies: [{ type: 'blork', count: 5 }, { type: 'floater', count: 3 }], pickups: [{ type: 'health' }], cover: 0.2, event: 'vehicle-escape',
        dialogue: [
          { speaker: 'IRIS', line: "Core's crippled. Ring's coming apart. Eleven seconds to the tear, Vanguard, and I am being VERY polite about that." },
          { speaker: 'Vanguard', line: 'Saving the eulogy for the other side of that gap.' },
          { speaker: 'IRIS', line: 'Three. Two. For the record — nice driving, marine.' },
          { speaker: 'Vanguard', line: 'Halo. Goodbye.' },
        ] },
    ],
  },
];
